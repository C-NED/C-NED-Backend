...
def get_caution_sections(minX : Optional[float] = Query(default=None,example=126.800000,description="최소 경도"),
                         maxX : Optional[float] = Query(default=None,example=127.890000,description="최대 경도"),
                         minY : Optional[float] = Query(default=None,example=34.900000,description="최소 위도"),
                         maxY : Optional[float] = Query(default=None,example=35.100000,description="최대 위도")):
